...
source ./eager-loading-first-n-benchmarks.sh  "$date_now"

php ./benchmark-scenarios/goodbye.php "$date_now" "$1" "LATEST_RESULTS_FIRST_N_EAGER.md" "LATEST_RESULTS_FIRST_N_EAGER.html" "$header"
